 ...
 */
#define DUAL_X_CARRIAGE     // Dallasfan9
#if ENABLED(DUAL_X_CARRIAGE)
  #define X1_MIN_POS X_MIN_POS    // Set to X_MIN_POS
  #define X1_MAX_POS X_BED_SIZE-5    // A max coordinate so the X1 carriage can't hit the parked X2 carriage     // Dallasfan9
  #define X2_MIN_POS    3        // A min coordinate so the X2 carriage can't hit the parked X1 carriage      // Dallasfan9 - JGMaker 5mm
  #define X2_MAX_POS   368        // The max position of the X2 carriage, typically also the home position      // Dallasfan9 -  手工测 284   增加上层向左偏移，减小向右  新机实测两喷头间距离为 435mm
  ...
  #define DEFAULT_DUPLICATION_X_OFFSET 155      // Dallasfan9
...
#define QUICK_HOME                          // If G28 contains XY do a diagonal move first      // Dallasfan9
...
//
#define ASSISTED_TRAMMING   //Dallasfan9
#if ENABLED(ASSISTED_TRAMMING)

  // Define positions for probe points.
  #define TRAMMING_POINT_XY { {  20, 20 }, { 280,  20 }, { 280, 280 }, { 20, 280 } }    //Dallasfan9 - X/Y posiitions for tramming without probe
...
//
#define BACKLASH_COMPENSATION     // Dallasfan9
#if ENABLED(BACKLASH_COMPENSATION)
  // Define values for backlash distance and correction.
  // If BACKLASH_GCODE is enabled these values are the defaults.
  #define BACKLASH_DISTANCE_MM { 0, 0, 0 } // (mm) One value for each linear axis
  #define BACKLASH_CORRECTION    1.0       // 0.0 = no correction; 1.0 = full correction      // Dallasfan9
  ...
  #define BACKLASH_SMOOTHING_MM 3 // (mm)     // Dallasfan9

  // Add runtime configuration and tuning of backlash values (M425)
  #define BACKLASH_GCODE      // Dallasfan9
...
// LCD Print Progress options
  ...
  #define EVENT_GCODE_SD_ABORT "G28XY"      // G-code to run on SD Abort Print (e.g., "G28XY" or "G27")     // Dallasfan9
  ...
  //#define BINARY_FILE_TRANSFER      // Dallasfan9 - TODO
 ...
 */
#define MINIMUM_STEPPER_POST_DIR_DELAY 200      // Dallasfan9
#define MINIMUM_STEPPER_PRE_DIR_DELAY 200       // Dallasfan9
 ...
 */
#define ADVANCED_PAUSE_FEATURE      // Dallasfan9
  ...
  #define ADVANCED_PAUSE_RESUME_PRIME          1  // (mm) Extra distance to prime nozzle after returning from park.     // Dallasfan9
...
#define REPORT_FAN_CHANGE   // Report the new fan speed when changed by M106 (and others)     // Dallasfan9
...
#define MEATPACK_ON_SERIAL_PORT_1     // Dallasfan9 - since 2022.2
#define MEATPACK_ON_SERIAL_PORT_2     // Dallasfan9 - since 2022.2
 ...
 */
#define HOST_ACTION_COMMANDS      // Dallasfan9 - since 2021.0
#if ENABLED(HOST_ACTION_COMMANDS)
  #define HOST_PAUSE_M76                // Tell the host to pause in response to M76      // Dallasfan9 - since 2022.1
  #define HOST_PROMPT_SUPPORT           // Initiate host prompts to get user feedback     // Dallasfan9 - since 2021.0
 ...
 */
#define CANCEL_OBJECTS      // Dallasfan9 since 2022.1
